    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title"><i class="ti ti-printer me-2"></i>Laporan Sample</h5>
            ...
            <div class="modal-body">
                <form class="form-horizontal needs-validation" novalidate method="GET" target="_blank" action="<?= base_url('view/laporan/sample') ?>">
                    ...
                    <div class="col-md-12 mt-3">
                        <div class="d-grid">
                            <button type="submit" class="btn bg-primary text-white"><i class="ti ti-printer me-2"></i> Cetak</button>
                        </div>
                    </div>
                </form>
            </div>
