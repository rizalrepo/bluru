    ...
    <div class="card">
        <div class="justify-content-between d-flex align-items-center">
            <h5 class="card-header">
                <i class="menu-icon tf-icons ti ti-chart-pie me-2"></i>Tambah Data Jenis Fasilitas
            </h5>
            <div class="pe-4">
        ...
        <div class="card-body pt-6">
            ...
            <form class="needs-validation" method="POST" novalidate enctype="multipart/form-data">
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <input type="text" name="nm_jenis_fasilitas" class="form-control" required>
...
if (isset($_POST['submit'])) {
    ...
    $tambah = $con->query("INSERT INTO jenis_fasilitas VALUES (
        default,
        '$nm_jenis_fasilitas'
    )");
