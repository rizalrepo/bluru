    ...
    <div class="card">
        <div class="justify-content-between d-flex align-items-center">
            <h5 class="card-header">
                <i class="menu-icon tf-icons ti ti-chart-pie me-2"></i>Data Jenis Fasilitas
            </h5>
            <div class="pe-4">
            ...
            <div class="table-responsive text-nowrap">
                <table id="example" class="table table-hover table-bordered nowrap" style="width:100%">
                    ...
                    <tbody>
                        <?php
                        $no = 1;
                        $data = $con->query("SELECT * FROM jenis_fasilitas ORDER BY id_jenis_fasilitas DESC");
                        while ($row = $data->fetch_array()) {
                        ?>
                            <tr>
                                <td class="text-center" width="5%"><?= $no++ ?></td>
                                <td><?= $row['nm_jenis_fasilitas'] ?></td>
