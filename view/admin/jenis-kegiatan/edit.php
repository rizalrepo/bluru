...
$id = $_GET['id'];
$row = $con->query("SELECT * FROM jenis_kegiatan WHERE id_jenis_kegiatan = '$id'")->fetch_array();
?>
    ...
    <div class="card">
        <div class="justify-content-between d-flex align-items-center">
            <h5 class="card-header">
                <i class="menu-icon tf-icons ti ti-category me-2"></i>Edit Data Jenis kegiatan
            </h5>
            <div class="pe-4">
        ...
        <div class="card-body pt-6">
            ...
            <form class="needs-validation" method="POST" novalidate enctype="multipart/form-data">
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <input type="text" name="nm_jenis_kegiatan" class="form-control" value="<?= $row['nm_jenis_kegiatan'] ?>" required>
